------- OpenFAST INPUT FILE -------------------------------------------
IEA 15 MW offshore reference model with jacket foundation, parked under extreme conditions
---------------------- SIMULATION CONTROL --------------------------------------
False                  Echo        - Echo input data to <RootName>.ech (flag)
"FATAL"                AbortLevel  - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
600.0                  TMax        - Total run time (s)
0.006                  DT          - Recommended module time step (s)
...
60                     WtrDpth     - Water depth (m)
0                      MSL2SWL     - Offset between still-water level and mean sea level (m) [positive upward]
---------------------- INPUT FILES ---------------------------------------------
"IEA-15-240-RWT-Jacket_ElastoDyn.dat"  EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"IEA-15-240-RWT-Jacket_ServoDyn.dat"   ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
"IEA-15-240-RWT_SeaSt.dat"      SeaStFile   - Name of file containing sea state input parameters (-)
"IEA-15-240-RWT-Jacket_HydroDyn.dat"   HydroFile   - Name of file containing hydrodynamic input parameters (quoted string)
"IEA-15-240-RWT-Jacket_SubDyn.dat"     SubFile     - Name of file containing sub-structural input parameters (quoted string)
